...
public class GameWindow extends GameGrid implements GGKeyListener {
	...
	private static final int APPLE_COUNT = 10; // 10 Apples
	...
	public GameWindow() {
		...
		super(GRID_WIDTH, GRID_HEIGHT, GRID_SIZE, Color.gray, false); // false = do not show toolbar
